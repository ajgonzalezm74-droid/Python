...
our %config = (
  ...
  CPPFLAGS => [ "-DANDROID -I/home/miequipo/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include -I/home/miequipo/Python/kivy_de_tu_calculadora/.buildozer/android/platform/build-arm64-v8a/build/python-installs/calculadora/arm64-v8a/include/python3.1" ],
  CPPINCLUDES => [  ],
  CXX => "/home/miequipo/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/bin/clang++ -target aarch64-linux-android21 -fomit-frame-pointer -march=armv8-a -fPIC",
  ...
  libdir => "",
  major => "1",
  makedepprog => "\$(CROSS_COMPILE)aarch64-linux-android21-clang",
  minor => "1.1",
  ...
  perlenv => {
      ...
      "PERL" => undef,
      "RANLIB" => "/home/miequipo/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-ranlib",
      "RC" => undef,
      "RCFLAGS" => undef,
      "WINDRES" => undef,
      "__CNF_CFLAGS" => undef,
